          ...
          <View key={bar.label} style={styles.barColumn}>
            <View
              style={[
                ...
                {
                  height: bar.height,
                  backgroundColor: bar.active ? '#1699CB' : '#D6ECFB',
                },
              ]}
            />
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          <View style={styles.heroCard}>
            <View style={styles.topActionsRow}>
              ...
              <Text style={styles.heroTitle}>Controle de Água</Text>
            ...
            <View style={styles.heroCenter}>
              <View style={styles.heroWaterIconWrap}>
                <Image source={waterIcon} style={styles.heroWaterIcon} resizeMode="contain" />
              </View>
              <Text style={styles.heroLabel}>Consumo atual</Text>
              <Text style={styles.heroValue}>12.4m³</Text>
            </View>

            <View style={styles.comparisonPill}>
              <Image source={trendUpIcon} style={styles.comparisonIcon} resizeMode="contain" />
              <Text style={styles.comparisonText}>12% melhor que o mês passado</Text>
            </View>
          </View>
          ...
          <ElevatedCard style={styles.tipCard}>
            ...
            <View style={styles.tipTextBlock}>
              ...
              <Text style={styles.tipDescription}>
                O pico no Sábado indica provável uso da máquina de lavar. Tente acumular mais roupas
